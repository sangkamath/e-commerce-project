import { Recycle, Shirt, HandHeart, Wind, Blend, Layers, ShieldAlert, Rainbow, Shapes } from "lucide-react";
import { PaintLine, PlantLine, Scale2, WaterFlashLine, PriceTag2, Shirt2 } from "../icons";
